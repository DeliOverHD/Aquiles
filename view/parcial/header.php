...
<header class="headerX"><h1 class="h1X"><a class="TitleX" href="<?php echo $fsConfig->getUrl() ?>index.php/home/index" title="Destino Travel" rel="home"><span class="TitleX">Descubre Buga</span></a></h1></header>
      ...
      <div class="collapse navbar-collapse fijoX" id="bs-example-navbar-collapse-1">
        ...
        <div class="floatRightX">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $fsConfig->getUrl() ?>index.php/home/loginUsuario">Iniciar Sesion</a></li>
